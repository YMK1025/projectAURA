  ...
  nodes: [
    ...
    /* 5A-1. Echo를 향해 */
    {
      ...
      choices: [
        ...
        { text: '"카이가 이걸 알면 어떻게 반응할까요?"',    next: 'ch5_aura_combat1', faction: 0, relation: { kai: 5 } },
    ...
    /* 5A-2. Nexus 거점 돌파 */
    {
      ...
      preText: '인천 외곽 폐공장. Nexus 요원들과 오라클 추종자들이 함께 방어선을 치고 있다.\n\n"연합했군요." 지유가 이를 간다.',
    ...
    /* 5A-4. 오라클 선발대 (NEW) */
    {
      ...
      choices: [
        { text: '"같이 돌파하죠."',                 next: 'ch5_aura_combat2', faction: 5 },
        { text: '"오라클 요원들은 자기 의지가 있어."', next: 'ch5_aura_combat2', faction: 0 },
        { text: '"선제 기습이 유리해요."',           next: 'ch5_aura_combat2', faction: 5 },
      ],
    },
    ...
    /* 5A-5. 오라클 정예 + 부사령관 */
    {
      ...
      title: 'Echo의 경호대',
      preText: '지하 2층 통로. 오라클 전투 요원들과 Nexus 부사령관이 길을 막는다.\n\n"여기까지야. Echo를 만나려면 내 시체를 밟고 가."',
