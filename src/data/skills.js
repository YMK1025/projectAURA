...
export const SKILLS = {
  ...
  smash: {
    ...
    lineage: 'physical', type: 'damage', target: 'enemy', statScale: 'power', element: 'physical',
    levels: [
  ...
  iron_wall: {
    ...
    lineage: 'physical', type: 'buff', target: 'self', element: 'physical',
    levels: [
  ...
  war_cry: {
    ...
    lineage: 'physical', type: 'debuff', target: 'enemy', element: 'physical',
    levels: [
  ...
  body_slam: {
    ...
    lineage: 'physical', type: 'damage', target: 'all_enemies', statScale: 'power', element: 'physical',
    levels: [
...
═══════════════════════════════════════ */
  ...
  tele_strike: {
    ...
    lineage: 'psychic', type: 'damage', target: 'enemy', statScale: 'mental', element: 'psychic',
    levels: [
  ...
  fate_distort: {
    ...
    lineage: 'psychic', type: 'buff', target: 'self', element: 'psychic',
    levels: [
  ...
  full_domination: {
    ...
    lineage: 'psychic', type: 'special', target: 'enemy', element: 'psychic',
    levels: [
  ...
  psychic_scan: {
    ...
    lineage: 'psychic', type: 'debuff', target: 'enemy', element: 'psychic',
    levels: [
  ...
  mind_blast: {
    ...
    lineage: 'psychic', type: 'damage', target: 'all_enemies', statScale: 'mental', element: 'psychic',
    levels: [
...
═══════════════════════════════════════ */
  ...
  element_burst: {
    ...
    lineage: 'nature', type: 'damage', target: 'enemy', statScale: 'mental', element: 'nature',
    levels: [
  ...
  thunder_storm: {
    ...
    lineage: 'nature', type: 'damage', target: 'all_enemies', statScale: 'power', element: 'nature',
    levels: [
  ...
  stone_wall: {
    ...
    lineage: 'nature', type: 'buff', target: 'self', element: 'nature',
    levels: [
  ...
  nature_wrath: {
    ...
    lineage: 'nature', type: 'damage', target: 'all_enemies', statScale: 'mental', element: 'nature',
    levels: [
